...
export function CategoryFilterChart({ col, value, setValue, remove, dataset }: Props) {
  ...
  return (
    <Grid container paddingTop={0}>
      ...
      <Grid item xs={9}>
        ...
        <div>
          {catValuesSample && (
            <ReactBarChart data={catValuesSample} value={value} setValue={setValue} isSmiles={dataset.columns[col]?.metaInformation.imgSmiles} />
          )}
        </div>
      </Grid>
    </Grid>
