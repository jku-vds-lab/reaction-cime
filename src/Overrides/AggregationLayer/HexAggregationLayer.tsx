...
const mapDispatchToProps = (dispatch: any) => ({
  setValueRangeProp: (range) => dispatch(setValueRange(range)),
  setUncertaintyRangeProp: (range) => dispatch(setUncertaintyRange(range)),
    ...
    React.useEffect(() => {
      if (aggregateSettings?.advancedSettings.deriveRange) {
        if (datasetValueRange != null) {
          setValueRangeProp(datasetValueRange);
          setUncertaintyRangeProp(datasetUncertaintyRange);
        }
      }
